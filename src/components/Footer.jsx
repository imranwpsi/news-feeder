export default function Footer({ categories, onCategoryChange }) {
    ...
    const secondCategories = categories.slice(-2);
                    ...
                    >
                        ...
                        <ul role="list" className="space-y-4">
                            {categories.map((category) => (
                                <li key={category}>
                                    <a className="text-sm font-semibold" href="javascript:void(0)" onClick={() => onCategoryChange(category)} className="capitalize">{category}</a>
                                </li>
                            ))}
                        </ul>
                        <ul role="list" className="space-y-4">
